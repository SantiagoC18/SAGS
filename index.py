...
def get_proyecto(proyecto_id):
    ...
    cur.execute("SELECT nombre, scrum_master FROM proyectos WHERE idproy = %s", (proyecto_id,))
...
def get_usuarios(proyecto_id):
    ...
    cur.execute("SELECT id, nombre, rol FROM usuarios")
...
def asignar_usuarios():
    ...
    for usuario_id in usuarios:
        cur.execute("INSERT INTO asignaciones (proyecto_id, usuario_id) VALUES (%s, %s)", (proyecto_id, usuario_id))
